...
;(function($){
	...
	MobileState.prototype.init = function(){
		...
		if(!_self.element.prev('.' + navBtnClass).length){
			...
			var $navBtn = $('<button className="mad-mobile-nav-btn"><span className="line line-top"></span><span className="line line-center"></span><span className="line line-bottom"></span></button>', {
				class: navBtnClass
