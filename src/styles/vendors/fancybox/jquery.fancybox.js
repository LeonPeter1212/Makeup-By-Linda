...
(function(window, document, $, undefined) {
  ...
  var defaults = {
    ...
    iframe: {
      // Iframe template
      tpl:
        '<iframe id="fancybox-frame{rnd}" name="fancybox-frame{rnd}" className="fancybox-iframe" frameborder="0" vspace="0" hspace="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen allowtransparency="true" src=""></iframe>',
    ...
    btnTpl: {
      download:
        '<a download data-fancybox-download className="fancybox-button fancybox-button--download" title="{{DOWNLOAD}}" href="javascript:;">' +
      ...
      smallBtn:
        '<button data-fancybox-close className="fancybox-close-small" title="{{CLOSE}}"><svg viewBox="0 0 32 32"><path d="M10,10 L22,22 M22,10 L10,22"></path></svg></button>',

      // Arrows
      arrowLeft:
        '<a data-fancybox-prev className="fancybox-button fancybox-button--arrow_left" title="{{PREV}}" href="javascript:;">' +
        '<svg viewBox="0 0 40 40">' +
      ...
      arrowRight:
        '<a data-fancybox-next className="fancybox-button fancybox-button--arrow_right" title="{{NEXT}}" href="javascript:;">' +
        '<svg viewBox="0 0 40 40">' +
    ...
    loadSlide: function(slide) {
      ...
      switch (type) {
        ...
        case "video":
          self.setContent(
            slide,
            '<video className="fancybox-video" controls controlsList="nodownload">' +
              '<source src="' +
              slide.src +
              '" type="' +
...
(function(document, $) {
  ...
  $.extend(FancyThumbs.prototype, {
    ...
    create: function() {
      ...
      if (!self.$grid) {
        // Create main element
        self.$grid = $('<div className="' + CLASS + " " + CLASS + "-" + self.opts.axis + '"></div>').appendTo(
